...
This script trains baseline ML models (Random Forest, XGBoost, Logistic Regression)
on the flood dataset and saves the best-performing model.
...
from backend.preprocessing import load_flood_data
...
def train_flood_models():
    ...
    # Load data
    print("\n[1/3] Loading data...")
    X_train, X_test, y_train, y_test, scaler = load_flood_data()
    ...
    joblib.dump(scaler, f'{model_dir}/flood_scaler.pkl')
    
    print(f"Flood model saved to: {model_dir}/flood_model.pkl")
    print(f"Flood scaler saved to: {model_dir}/flood_scaler.pkl")
    print("\n" + "="*60)
